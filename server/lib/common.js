...
exports.CONNECTION_ID = Buffer
		.concat([ toUInt32(0x417), toUInt32(0x27101980) ])
exports.ACTIONS = {
	CONNECT : 0,
	ANNOUNCE : 1,
	SCRAPE : 2,
...
/**
 * `querystring.parse` using `unescape` instead of decodeURIComponent, since
 * bittorrent clients send non-UTF8 querystrings
 * 
 * @param {string}
 *            q
 * @return {Object}
...
/**
 * `querystring.stringify` using `escape` instead of encodeURIComponent, since
 * bittorrent clients send non-UTF8 querystrings
 * 
 * @param {Object}
 *            obj
